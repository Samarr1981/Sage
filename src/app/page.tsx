...
import type { InterviewPlan } from '@/lib/agent/buildVapiSystemPrompt';
...
export default function Home() {
  ...
  // The temporary per-interview Vapi assistant id from /api/realtime/start-call.
  // Mirrored here (alongside planRef) so handleRestart can fire a best-effort
  // cleanup call to /api/realtime/end-call independent of the hook's own
  // call-end-triggered cleanup.
  ...
  const handleRestart = () => {
    ...
    // Best-effort cleanup of the temporary per-interview assistant, in case
    // disconnect() above doesn't get a chance to fire the hook's own
    // call-end-triggered /api/realtime/end-call cleanup. Fire-and-forget,
    // swallow errors — deleting an already-deleted assistant is harmless.
